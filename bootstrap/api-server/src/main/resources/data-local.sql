...
VALUES (1, 'qa-seller-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '멍청한돼지0009', '1975-11-08', 'SELLER', '서울시 종로구',
       ...
       (5, 'qa-buyer2-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '졸린토끼0042', '1998-07-22', 'BUYER', '서울시 마포구',
        '010-3333-4444', '이수현', 'ACTIVE', 'auth0|698184500000000000000001', NOW(), NOW(), 'SYSTEM', 'SYSTEM'),
       (6, 'qa-buyer3-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '배고픈강아지0007', '2001-12-25', 'BUYER', '서울시 서초구',
...
-- -----------------------------------------------------------------------------
-- 3. FUNDING_MEMBER (펀딩 회원 - core 모듈) — V1.2.0
-- -----------------------------------------------------------------------------
