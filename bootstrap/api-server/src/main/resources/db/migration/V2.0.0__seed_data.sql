-- ============================================================
-- V2.0.0 Seed Data (data-local.sql → PostgreSQL conversion)
-- Replaces: V1.0.0, V1.0.1, V1.1.0, V1.2.0
-- Fixes: #409 order_item_type enum (FUNDING_GIFT, not FUNDING)
-- ============================================================

SET search_path TO g7app;

-- Spring Modulith event table column expansion
ALTER TABLE IF EXISTS event_publication
    ALTER COLUMN serialized_event TYPE TEXT;
ALTER TABLE IF EXISTS event_publication_archive
    ALTER COLUMN serialized_event TYPE TEXT;
...
-- ============================================================
-- 2. member_replica (6) — no sequence (manually assigned ID)
-- ============================================================
...
-- ============================================================
-- 3. core_member_replica (6) — no sequence (manually assigned ID)
-- ============================================================
...
SELECT setval('wallet_id_seq', 100, false);
...
SELECT setval('cart_id_seq', 100, false);


-- ============================================================
-- 6. product (91, seller_id=3)
-- ============================================================
...
SELECT setval('product_id_seq', 200, false);
...
SELECT setval('wishlist_id_seq', 100, false);
...
VALUES (1, 2, 17, 'COMPLETED', '2026-02-27 04:38:07.137213', '2026-02-27 04:38:07.137213', '2026-02-27 05:02:52.542501',
       ...
       (2, 2, 91, 'PENDING', '2026-02-27 04:38:18.888371', '2026-02-27 04:38:18.888371', '2026-02-27 05:03:04.54353',
        NULL, NULL),
       (3, 2, 101, 'PENDING', '2026-02-27 04:38:34.915845', '2026-02-27 04:38:34.921555', '2026-02-27 04:38:34.921555',
        NULL, NULL),
       (4, 2, 52, 'PENDING', '2026-02-27 04:38:45.005384', '2026-02-27 04:38:45.013825', '2026-02-27 04:38:45.013825',
        NULL, NULL),
       (5, 3, 28, 'PENDING', '2026-02-27 04:39:41.138494', '2026-02-27 04:39:41.152269', '2026-02-27 04:39:41.152269',
        NULL, NULL),
       (6, 3, 94, 'PENDING', '2026-02-27 04:39:51.842625', '2026-02-27 04:39:51.845744', '2026-02-27 04:39:51.845744',
        NULL, NULL),
       (7, 3, 69, 'PENDING', '2026-02-27 04:40:01.608242', '2026-02-27 04:40:01.617223', '2026-02-27 04:40:01.617223',
        NULL, NULL),
       (8, 3, 76, 'PENDING', '2026-02-27 04:40:09.549441', '2026-02-27 04:40:09.557367', '2026-02-27 04:40:09.557367',
        NULL, NULL),
       (9, 2, 13, 'IN_PROGRESS', '2026-02-27 04:42:38.567651', '2026-02-27 04:42:38.567651',
        '2026-02-27 04:46:27.969806', NULL, NULL),
       (10, 2, 32, 'PENDING', '2026-02-27 04:42:41.91097', '2026-02-27 04:42:41.918441', '2026-02-27 04:42:41.918441',
        NULL, NULL),
       (11, 2, 38, 'REQUESTED_CONFIRM', '2026-02-27 04:42:43.665596', '2026-02-27 04:42:43.665596',
        '2026-02-27 04:46:27.984245', NULL, NULL),
       (12, 2, 75, 'PENDING', '2026-02-27 04:42:52.891707', '2026-02-27 04:42:52.89553', '2026-02-27 04:42:52.89553',
        NULL, NULL),
       (13, 2, 58, 'PENDING', '2026-02-27 04:42:58.126237', '2026-02-27 04:42:58.127218', '2026-02-27 04:42:58.127218',
        NULL, NULL),
       (14, 2, 51, 'PENDING', '2026-02-27 04:43:03.599998', '2026-02-27 04:43:03.603226', '2026-02-27 04:43:03.603226',
        NULL, NULL),
       (15, 2, 78, 'PENDING', '2026-02-27 04:43:10.611364', '2026-02-27 04:43:10.613853', '2026-02-27 04:43:10.613853',
        NULL, NULL),
       (16, 2, 76, 'PENDING', '2026-02-27 04:43:12.207661', '2026-02-27 04:43:12.20892', '2026-02-27 04:43:12.20892',
        NULL, NULL),
       (17, 3, 11, 'PENDING', '2026-02-27 04:44:44.169043', '2026-02-27 04:44:44.188167', '2026-02-27 04:44:44.188167',
        NULL, NULL),
       (18, 3, 96, 'PENDING', '2026-02-27 04:44:57.019013', '2026-02-27 04:44:57.026863', '2026-02-27 04:44:57.026863',
        NULL, NULL),
       (19, 3, 97, 'PENDING', '2026-02-27 04:45:00.677498', '2026-02-27 04:45:00.688314', '2026-02-27 04:45:00.688314',
        NULL, NULL),
       (20, 3, 101, 'PENDING', '2026-02-27 04:45:01.140464', '2026-02-27 04:45:01.146291', '2026-02-27 04:45:01.146291',
        NULL, NULL),
       (21, 3, 98, 'PENDING', '2026-02-27 04:45:01.145349', '2026-02-27 04:45:01.150481', '2026-02-27 04:45:01.150481',
        NULL, NULL),
       (22, 3, 68, 'PENDING', '2026-02-27 04:45:09.424229', '2026-02-27 04:45:09.427839', '2026-02-27 04:45:09.427839',
        NULL, NULL),
       (23, 3, 73, 'PENDING', '2026-02-27 04:45:10.486583', '2026-02-27 04:45:10.487981', '2026-02-27 04:45:10.487981',
        NULL, NULL),
       (24, 3, 74, 'REQUESTED_CONFIRM', '2026-02-27 04:45:11.92899', '2026-02-27 04:45:11.92899',
        '2026-02-27 05:02:18.616474', NULL, NULL)
ON CONFLICT DO NOTHING;

SELECT setval('wishlist_item_id_seq', 100, false);
...
-- ============================================================
  -- 10. funding (4: IN_PROGRESS, ACHIEVED x2, ACCEPTED)
  -- ============================================================
INSERT INTO funding (id, version, wishlist_item_id, product_id, product_name, image_key, receiver_id,
                     target_amount, current_amount, status,
                     deadline, achieved_at, closed_at,
                     created_at, updated_at, created_by, updated_by)
VALUES (2, 1, 11, 38, '킨토 데이오프 텀블러', 'products/38/kinto-tumbler.jpg', 2,
...
SELECT setval('funding_id_seq', 100, false);

-- ============================================================
-- 11. funding_participant_member (4)
-- ============================================================
INSERT INTO funding_participant_member (id, funding_id, participant_id, nick_name, amount,
                                        created_at, updated_at, created_by, updated_by)
VALUES (2, 2, 3, '멍청한고양이2013', 45000, '2026-02-27 04:46:27.8179', '2026-02-27 04:46:27.817', NULL, NULL),
...
SELECT setval('funding_participant_member_id_seq', 100, false);

-- ============================================================
-- 12. orders (5: PAID, CONFIRMED, CREATED, PAID, CANCELED)
-- ============================================================
...
SELECT setval('payment_id_seq', 100, false);

-- ============================================================
-- 15. payment_history (5)
-- ============================================================
...
SELECT setval('payment_history_id_seq', 100, false);
...
SELECT setval('wallet_history_id_seq', 100, false);

-- ============================================================
-- 17. friendships (2: ACCEPTED x2)
-- ============================================================
...
-- 18. notifications (5)
-- ============================================================
INSERT INTO notifications (id, recipient_id, type, title, content, is_read, read_at,
                           reference_id, reference_type,
                           source_event_id, source_event_type, source_event_source,
                           created_at, updated_at, created_by, updated_by)
VALUES
    -- funding 2 ACHIEVED → receiver(member 2)에게 알림
    (1, 2, 'FUNDING_ACHIEVED', '펀딩 목표 달성!',
     '킨토 데이오프 텀블러 펀딩이 목표 금액을 달성했습니다.',
     true, '2026-02-27 05:00:00', '2', 'FUNDING',
     'evt-seed-001', 'FundingAchievedEvent', 'bc-core',
     '2026-02-27 04:46:27', '2026-02-27 05:00:00', NULL, NULL),

    -- funding 3 ACCEPTED → receiver(member 2)에게 알림
    (2, 2, 'FUNDING_ACHIEVED', '펀딩 목표 달성!',
     '벨킨 3-in-1 맥세이프 충전기 펀딩이 목표 금액을 달성했습니다.',
     false, NULL, '3', 'FUNDING',
     'evt-seed-002', 'FundingAchievedEvent', 'bc-core',
     '2026-02-27 04:46:27', '2026-02-27 04:46:27', NULL, NULL),

    -- payment 1 성공 → buyer(member 2)에게 알림
    (3, 2, 'PAYMENT_SUCCEEDED', '결제가 완료되었어요',
     '359,000원 결제가 완료되었습니다.',
     true, '2026-02-05 18:00:00', '1', 'ORDER',
     'evt-seed-003', 'PaymentSucceededEvent', 'bc-core',
     '2026-02-05 17:05:00', '2026-02-05 18:00:00', NULL, NULL),

    -- friendship 1 요청 → receiver(member 3)에게 알림
    (4, 3, 'FRIEND_REQUEST_RECEIVED', '친구 요청이 도착했어요',
     '나른한고양이0013님이 친구 요청을 보냈습니다.',
     true, '2026-02-07 12:00:00', '1', 'FRIENDSHIP',
     'evt-seed-004', 'FriendRequestReceivedEvent', 'bc-member',
     '2026-02-07 12:00:00', '2026-02-07 12:00:00', NULL, NULL),

    -- friendship 1 수락 → requester(member 2)에게 알림
    (5, 2, 'FRIEND_REQUEST_ACCEPTED', '친구 요청이 수락되었어요',
     '멍청한고양이2013님이 친구 요청을 수락했습니다.',
     false, NULL, '1', 'FRIENDSHIP',
     'evt-seed-005', 'FriendRequestAcceptedEvent', 'bc-member',
     '2026-02-07 12:00:00', '2026-02-07 12:00:00', NULL, NULL)
ON CONFLICT DO NOTHING;
...
-- ============================================================
-- 19. settlement_item (2)
--     order 2 (CONFIRMED) → order_item 2 기반
-- ============================================================
INSERT INTO settlement_item (id, order_id, order_item_id, payment_id, seller_id,
                             target_id, target_type, type, status,
                             paid_amount, pg_fee, platform_fee, settlement_amount,
                             expected_date, confirmed_at, settled_at, cancelled_at,
                             retry_count, origin_id, history_id,
                             created_at, updated_at, created_by, updated_by)
VALUES
    ...
    (1, 2, 2, 2, 3,
     ...
     0, NULL, 1,
     '2026-02-06 10:00:00', '2026-02-13 03:00:00', 'SYSTEM', 'SYSTEM'),
...
SELECT setval('settlement_item_id_seq', 100, false);

-- ============================================================
-- 20. settlement_queue (1)
-- ============================================================
INSERT INTO settlement_queue (id, settlement_item_id, status, created_at, updated_at)
VALUES (1, 2, 'READY', '2026-02-12 00:00:00', '2026-02-12 00:00:00')
ON CONFLICT DO NOTHING;

SELECT setval('settlement_queue_id_seq', 100, false);

-- ============================================================
-- 21. settlement_history (1)
-- ============================================================
INSERT INTO settlement_history (id, seller_id, settlement_date, item_count,
                                sales_amount, pg_fee, platform_fee, settlement_amount,
                                status, settled_at, reference_history_id)
VALUES (1, 3, '2026-02-13', 1, 23000.00, 690.00, 1150.00, 21160.00,
        'COMPLETED', '2026-02-13 03:00:00', NULL)
ON CONFLICT DO NOTHING;

SELECT setval('settlement_history_id_seq', 100, false);

-- ============================================================
-- Seed Data Summary (data-local.sql → PostgreSQL conversion)
-- ============================================================
-- Members: 6 (SELLER 2, BUYER 3, ADMIN 1)
--   ID 1: qa-seller  (멍청한돼지0009)
--   ID 2: qa-buyer   (나른한고양이0013)
--   ID 3: qa-seller2 (멍청한고양이2013)
--   ID 4: admin      (관리자)
--   ID 5: qa-buyer2  (졸린토끼0042)
--   ID 6: qa-buyer3  (배고픈강아지0007)
-- Wallets: 6 | Carts: 6 | Products: 91 (ID 11-101)
-- Wishlists: 6 | WishlistItems: 24 | CartItems: 1
-- Fundings: 4 | FundingParticipants: 4
-- Orders: 5 | OrderItems: 6
-- Payments: 3 | PaymentHistory: 5
-- WalletHistory: 5 | Friendships: 2
-- Notifications: 5 | SettlementItems: 2
-- SettlementQueue: 1 | SettlementHistory: 1
-- ============================================================
