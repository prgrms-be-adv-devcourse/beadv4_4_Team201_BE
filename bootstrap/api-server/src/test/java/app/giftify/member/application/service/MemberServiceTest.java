...
class MemberServiceTest {
    ...
    @Test
    @DisplayName("[프로필 업데이트] 닉네임 미입력 시 기존 자동생성 닉네임 유지 - signup")
    void signup_WithoutNickname_KeepsAutoGenerated() {
        // given
        String authSub = "auth0|12345";
        SignupRequest request = new SignupRequest(
                null,
        ...
        // then
        assertThat(result.getNickname()).isEqualTo("autoNickname");
        verify(memberRepositoryPort).save(any(Member.class));
    }
