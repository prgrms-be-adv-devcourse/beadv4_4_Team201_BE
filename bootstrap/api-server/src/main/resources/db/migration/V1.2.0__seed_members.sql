...
VALUES
    (1, 'qa-seller-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '멍청한돼지0009', '1975-11-08', 'SELLER',
     '서울시 종로구', '010-1234-5678', '김주영', 'ACTIVE', 'auth0|6981838d48f8397cae06ddb0',
     NOW(), NOW(), 'SYSTEM', 'SYSTEM'),
    (2, 'qa-buyer-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '나른한고양이0013', '2003-02-14', 'BUYER',
    ...
    (3, 'qa-seller-giftify@naver.com', '5@675995dC43786719eb76Cd455d3b368', '멍청한고양이2013', '2003-02-14', 'SELLER',
     ...
     NOW(), NOW(), 'SYSTEM', 'SYSTEM'),
    (4, 'admin-giftify@team201.dev', '@675995dC43786719eb76Cd455d3b368', '관리자', '1999-01-01', 'ADMIN',
     '서울시 강남구', '010-0000-0000', 'TEAM201', 'ACTIVE', 'auth0|6981843a226ff0ca1e6a5ae8',
     NOW(), NOW(), 'SYSTEM', 'SYSTEM'),
    (5, 'qa-buyer2-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '졸린토끼0042', '1998-07-22', 'BUYER',
     '서울시 마포구', '010-3333-4444', '이수현', 'ACTIVE', 'auth0|698184500000000000000001',
     NOW(), NOW(), 'SYSTEM', 'SYSTEM'),
    (6, 'qa-buyer3-giftify@team201.dev', '1Q@W3r4R1q2w3e4r', '배고픈강아지0007', '2001-12-25', 'BUYER',
