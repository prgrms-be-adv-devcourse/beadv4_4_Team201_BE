...
VALUES
    (1, 2, 'ORD-20260205-A1B2C3D4E5F6-20260205170000', 359000.00, 1, 'CARD', 'PAID',
     ...
     '2026-02-05 17:00:00', '2026-02-05 17:05:00', null),
    ...
    (2, 2, 'ORD-20260205-B2C3D4E5F6G7-20260205171000', 23000.00, 1, 'CARD', 'CONFIRMED',
     ...
     '2026-02-05 17:10:00', '2026-02-06 10:00:00', null),

    (3, 5, 'ORD-20260207-C3D4E5F6G7H8-20260207120000', 415000.00, 1, 'CARD', 'CREATED',
     NULL, NULL, NULL, NULL, NULL,
     '2026-02-07 12:00:00', '2026-02-07 12:00:00',null),

    (4, 6, 'ORD-20260208-D4E5F6G7H8I9-20260208140000', 438000.00, 2, 'KAKAO_PAY', 'PAID',
     'toss_pk_20260208_0004', 'toss_tx_20260208_0004', '2026-02-08 14:05:00', NULL, NULL,
     '2026-02-08 14:00:00', '2026-02-08 14:05:00', null),
    ...
    (5, 5, 'ORD-20260208-E5F6G7H8I9J0-20260208150000', 89000.00, 1, 'CARD', 'CANCELED',
     ...
     '2026-02-08 15:00:00', '2026-02-08 16:00:00', null);
...
VALUES
    ...
    (3, 'idem-20260208-0004', 'FUNDING', 'KAKAO_PAY',
     ...
     438000.00, 438000.00, '[{"targetId":2,"amount":{"amount":23000},"sellerId":3},{"targetId":3,"amount":{"amount":415000},"sellerId":3}]', 'PAID',
...
VALUES
    ...
    (5, 3, 'idem-20260208-0004-created', 'CREATED', '2026-02-08 14:00:00', NULL,
     '2026-02-08 14:00:00', '2026-02-08 14:00:00', 'SYSTEM', 'SYSTEM'),
    (6, 3, 'idem-20260208-0004-paid', 'PAID', '2026-02-08 14:05:00', NULL,
...
INSERT INTO wallet_history (id, wallet_id, transaction_type, amount, balance_after,
                            ...
                            created_at, updated_at, created_by, updated_by)
VALUES
    (1, 1, 'CHARGE', 100000.00, 100000.00, 'CHARGE', 'CHG-20260201-001', '2026-02-01 10:00:00',
     '2026-02-01 10:00:00', '2026-02-01 10:00:00', 'SYSTEM', 'SYSTEM'),
    (2, 2, 'CHARGE', 500000.00, 500000.00, 'CHARGE', 'CHG-20260205-001', '2026-02-04 10:00:00',
     '2026-02-04 10:00:00', '2026-02-04 10:00:00', 'SYSTEM', 'SYSTEM'),
    (3, 2, 'PAYMENT', 359000.00, 141000.00, 'PAYMENT', 'ORD-20260205-A1B2C3D4E5F6-20260205170000', '2026-02-05 17:05:00',
     '2026-02-05 17:05:00', '2026-02-05 17:05:00', 'SYSTEM', 'SYSTEM'),
    (4, 2, 'PAYMENT', 23000.00, 118000.00, 'PAYMENT', 'ORD-20260205-B2C3D4E5F6G7-20260205171000', '2026-02-05 17:15:00',
     '2026-02-05 17:15:00', '2026-02-05 17:15:00', 'SYSTEM', 'SYSTEM'),
    (5, 3, 'CHARGE', 1000000.00, 1000000.00, 'CHARGE', 'CHG-20260201-002', '2026-02-01 12:00:00',
     '2026-02-01 12:00:00', '2026-02-01 12:00:00', 'SYSTEM', 'SYSTEM'),
    (6, 5, 'CHARGE', 300000.00, 300000.00, 'CHARGE', 'CHG-20260207-001', '2026-02-07 09:00:00',
     '2026-02-07 09:00:00', '2026-02-07 09:00:00', 'SYSTEM', 'SYSTEM'),
    (7, 6, 'CHARGE', 500000.00, 500000.00, 'CHARGE', 'CHG-20260208-001', '2026-02-08 10:00:00',
     '2026-02-08 10:00:00', '2026-02-08 10:00:00', 'SYSTEM', 'SYSTEM'),
    (8, 6, 'PAYMENT', 438000.00, 62000.00, 'PAYMENT', 'ORD-20260208-D4E5F6G7H8I9-20260208140000', '2026-02-08 14:05:00',
     '2026-02-08 14:05:00', '2026-02-08 14:05:00', 'SYSTEM', 'SYSTEM');
