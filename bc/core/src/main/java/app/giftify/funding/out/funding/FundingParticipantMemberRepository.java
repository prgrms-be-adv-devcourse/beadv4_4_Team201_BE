...
import app.giftify.funding.domain.funding.FundingParticipantMember;
...
public interface FundingParticipantMemberRepository extends JpaRepository<FundingParticipantMember, Long> {
    ...
    @Query("SELECT new app.giftify.funding.out.funding.MyFundingInfo(fpm.funding, SUM(fpm.amount)) " +
