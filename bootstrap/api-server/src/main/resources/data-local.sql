...
-- -----------------------------------------------------------------------------
-- 2. PRODUCT_MEMBER_VIEWS (BC 별 read-model — bc/product) — V1.1.0
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. CART_MEMBER_VIEWS (BC 별 read-model — bc/cart) — V1.1.0
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. WISHLIST_MEMBER_VIEWS (BC 별 read-model — bc/wishlist) — V1.1.0
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. FUNDING_MEMBER_VIEWS (BC 별 read-model — bc/core/funding) — V1.1.0
-- -----------------------------------------------------------------------------
...
VALUES (1, 'FUNDING', 'CARD',
       ...
       (2, 'FUNDING', 'CARD',
        ...
        23000.00, 23000.00, 0.00, 0.00, 'PAID',
       ...
       (3, 'FUNDING', 'KAKAO_PAY',
        ...
        448000.00, 448000.00, 0.00, 0.00, 'PAID',
